...
//=================
//Menu
let iconMenu = document.querySelector(".catalog-menu");
if (iconMenu != null) {
	let delay = 500;
...
// sub-menu
const catalogBtn = document.querySelectorAll(".menu-catalog__button");
const catalogItem = document.querySelectorAll(".sub-menu-catalog");
...
//favorite
let btnFavorite = document.querySelector(".icon-heart");
...
//bar
let btnBar = document.querySelector(".icon-bar-chart-2");
btnBar.addEventListener("click", function (e) {
    if (unlock) {
        btnBar.classList.toggle("_active");
    };
});

//cart
let btnCart = document.querySelector(".footer-item__button");
btnCart.addEventListener("click", function (e) {
    if (unlock) {
        btnCart.classList.toggle("_active");
    };
});

// tab
const tabBtn = document.querySelectorAll(".recommendations__button");
const tabItem = document.querySelectorAll(".recommendations-item");
...
let slider_about_01 = new Swiper('.about-swiper_01', {
	observer: true,
	observeParents: true,
	slidesPerView: 1,
	speed: 800,
...
let slider_about_02 = new Swiper('.about-swiper_02', {
	observer: true,
	observeParents: true,
	slidesPerView: 1,
	speed: 800,
...
let slider_about_03 = new Swiper('.about-swiper_03', {
	observer: true,
	observeParents: true,
	slidesPerView: 1,
	speed: 800,
...
let slider_about_04 = new Swiper('.about-swiper_04', {
	observer: true,
	observeParents: true,
	slidesPerView: 1,
	speed: 800,
	loop: true,
	navigation: {
		nextEl: '.swiper-button-next_04',
	},
});	

/////////////////////////////////////////////////////////////

let slider_main_01 = new Swiper('.swiper-main_01', {
	observer: true,
	observeParents: true,
	slidesPerView: 2,
	slidesPerGroup: 2,
	...
	simulateTouch: false,
	navigation: {
		nextEl: '.main__swiper-button-next_01',
		prevEl: '.main__swiper-button-prev_01',
	},
});	

let slider_main_02 = new Swiper('.swiper-main_02', {
	observer: true,
	observeParents: true,
	slidesPerView: 2,
	slidesPerGroup: 2,
	...
	simulateTouch: false,
	navigation: {
		nextEl: '.main__swiper-button-next_02',
		prevEl: '.main__swiper-button-prev_02',
	},
});	

let slider_main_03 = new Swiper('.swiper-main_03', {
	observer: true,
	observeParents: true,
	slidesPerView: 2,
	slidesPerGroup: 2,
	...
	simulateTouch: false,
	navigation: {
		nextEl: '.main__swiper-button-next_03',
		prevEl: '.main__swiper-button-prev_03',
	},
});	

let slider_main_04 = new Swiper('.swiper-main_04', {
	observer: true,
	observeParents: true,
	slidesPerView: 2,
	slidesPerGroup: 2,
	...
	simulateTouch: false,
	navigation: {
		nextEl: '.main__swiper-button-next_04',
		prevEl: '.main__swiper-button-prev_04',
	},
});	

let slider_main_05 = new Swiper('.swiper-main_05', {
	observer: true,
	observeParents: true,
	slidesPerView: 2,
	slidesPerGroup: 2,
	...
	simulateTouch: false,
	navigation: {
		nextEl: '.main__swiper-button-next_05',
		prevEl: '.main__swiper-button-prev_05',
	},
});

let slider_main_06 = new Swiper('.swiper-main_06', {
	observer: true,
	observeParents: true,
	slidesPerView: 2,
	slidesPerGroup: 2,
	...
	simulateTouch: false,
	navigation: {
		nextEl: '.main__swiper-button-next_06',
		prevEl: '.main__swiper-button-prev_06',
	},
});	
...
let sliderItem = new Swiper('.item-swiper', {
	observer: true,
	observeParents: true,
	slidesPerView: 1,
	speed: 400,
	//loop: true,
	scrollbar: {
		el: '.item__image-scrollbar',
	},
});	

/////

let sliderPartner = new Swiper('.partners__swiper', {
	observer: true,
	observeParents: true,
	slidesPerView: 6,
	slidesPerGroup: 6,
...
let sliderRecommendations = new Swiper('.recommendations__swiper', {
	observer: true,
	observeParents: true,
	slidesPerView: 4,
	simulateTouch: false,
